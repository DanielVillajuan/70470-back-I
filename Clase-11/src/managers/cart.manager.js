...
class CartManager {
  ...
  async saveProdToCart(idCart, idProd){
    try {
        ...
        // ya tengo el producto por id y el carrito por id.
        ...
        // recuperar el producto y el carrito,
        // insertar el producto en el array de produtcs del carrito.
        // si existe el produto, le aumento al quantity + 1.
        // sino lo creo con quantity en 1.
